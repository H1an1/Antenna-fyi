  ...
  return (
    ...
    >
      ...
      <img
        src="/lefthand.png"
        alt=""
        className="absolute pointer-events-none will-change-transform w-[75%] left-[-90px] md:w-[45%] md:left-[calc(2%+40px)]"
        style={{
          top: "calc(18% + 100px)",
          height: "auto",
      ...
      >
        ...
        <div className="absolute top-0 bottom-0 w-[250vw] -left-[85vw] -translate-y-[60px] md:w-full md:left-0 md:right-0 md:translate-y-0 scale-[0.5] md:scale-100 origin-center md:origin-center">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            src="/hand-wash.png"
            alt=""
