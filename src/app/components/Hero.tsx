  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute top-0 bottom-0 w-[250vw] -left-[90vw] -translate-y-[40px] md:w-full md:left-0 md:right-0 md:translate-y-0 scale-[0.5] md:scale-100 origin-center md:origin-center">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            src="/hand-wash.png"
            alt=""
